...
public class q2 extends Fragment implements  View.OnClickListener{
    ...
    public void onClick(View view) {
        Objects.requireNonNull(getActivity()).findViewById(R.id.text_square2).setEnabled(false);
        ...
        switch (view.getId()) {
            case R.id.answer1:
                ...
                if (answerGiven == correctAnswer) {//да - это верный ответ
                    ...
                    getActivity().findViewById(R.id.text_square2).setBackgroundResource(R.color.correctAnswer);
                    counter++;
                    try {
