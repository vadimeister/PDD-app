...
public class q6 extends Fragment implements  View.OnClickListener{
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        View view =
                inflater.inflate(R.layout.ticket1_q6, container, false);
        Objects.requireNonNull(getActivity()).findViewById(R.id.text_square6).setBackgroundResource(R.drawable.now);
        answer1 = view.findViewById(R.id.answer1);
        answer2 = view.findViewById(R.id.answer2);
        answer3 = view.findViewById(R.id.answer3);
        String[] answers = getResources().getStringArray(R.array.q6Answers);
    ...
    public void onClick(View view) {
        Objects.requireNonNull(getActivity()).findViewById(R.id.text_square6).setEnabled(false);
        ...
        switch (view.getId()) {
            case R.id.answer1:
                ...
                if (answerGiven == correctAnswer) {//да - это верный ответ
                    ...
                    getActivity().findViewById(R.id.text_square6).setBackgroundResource(R.color.correctAnswer);
                    counter++;
                    try {
                    ...
                    Objects.requireNonNull(getActivity()).findViewById(R.id.text_square6).setBackgroundResource(R.color.wrongAnswer);
                    try {
                        ((q1.Postman) activity).fragmentMail(counter);
                    } catch (ClassCastException ignored) {}
                }
            ...
            case R.id.answer2:
                ...
                if (answerGiven == correctAnswer) {//да - это верный ответ
                    ...
                    buttonCorrectAnswer.setBackgroundResource(R.color.correctAnswer);
                    getActivity().findViewById(R.id.text_square6).setBackgroundResource(R.color.wrongAnswer);
                    try {
                        ((q1.Postman) activity).fragmentMail(counter);
                    } catch (ClassCastException ignored) {}
                }
